...
Version: 1.03.1
------------------------------------------------------
Description: VGuide GuideSteps Alliance
	1.99a
...
----------Introduction
  [1] = {
    ...
    items = {
	  ...
	  [4] = { str = "edited by adding Brian Kopps' guide for Alliance by Kira and Cdlp..." },
      [5] = { str = "." },
...
for k1, _ in pairs(VGuideStepsAlly) do
  if type(VGuideStepsAlly[k1].items) == "table" then
    for k2, v2 in pairs(VGuideStepsAlly[k1].items) do
      if v2 then
        local opentext = {
          [1] = {
            ["find"] = "#ACCEPT",
        ...
        for n = 1, getn(opentext) do
          VGuideStepsAlly[k1].items[k2].str = gsub(VGuideStepsAlly[k1].items[k2].str, opentext[n]["find"],opentext[n]["replace"])
        end
        VGuideStepsAlly[k1].items[k2].str = gsub(VGuideStepsAlly[k1].items[k2].str, "#","|r")
      end
    end
  end
end
