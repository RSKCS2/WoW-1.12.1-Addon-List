...
PERFECTSHOT_VERSION = "testversion6";
...
if GetLocale() == "deDE" then
  ...
  PERFECTSHOT_MYADDONS_RELEASEDATE = "25. Juni 2006";
  ...
  PERFECTSHOT_MYADDONS_RELEASEDATE = "June 25, 2006";
