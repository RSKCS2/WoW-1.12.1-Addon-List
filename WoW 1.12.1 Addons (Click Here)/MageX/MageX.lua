...
MX = {
	...
	MSG_ClassError 	= "desactivated, you are not a Mage.",
	...
	MSG_Portal2 	= ", you will have 30 seconds to right-click it to be teleported >>",
...
function MX_SlashHandler(arg1)
	...
	if (string.lower(arg1) == "status") then
		MX_Msg("This fonction is disabled for now, it will be fixed in next version.", "USER");
