	...
	AM_ALPHAMAP_LIST = {
			...
			{	name = "黑石深淵",			-- Blackrock Depths
				...
				dtl8  = { text = "瑟爾倫", colour = AM_RED, coords = { {42, 73.4} }, symbol = { " " },
						tooltiptxt = "NPC 群領隊", lootid = "BRDTheldren" },
			...
			{	name = "安其拉廢墟",		-- Ruins of Ahn'Qiraj
				...
				dtl1  = { text = AM_INSTANCE_ENTRANCES, colour = AM_GREEN, coords = { {64, 2} }, symbol = { AM_ENTRANCE_SYMBOL },
						tooltiptxt = "", leaveGap = 1 },
				dtl2  = { text = "庫林納克斯,\n安多洛夫中將,\n四個卡多雷精英", colour = AM_RED, coords = { {55, 29} }, symbol = { "1" },
						tooltiptxt = "首領 & 菁英", lootid = "AQ20Kurinnaxx" },
				dtl3  = { text = "奎茲上尉", colour = AM_RED, coords = { {52.1, 46.9} }, symbol = { "2" },
						tooltiptxt = "Lvl63 菁英", lootid = "AQ20CAPTIAN" },
				dtl4  = { text = "圖畢德上尉", colour = AM_RED, coords = { {55.4, 46.9} }, symbol = { "3" },
						tooltiptxt = "Lvl63 菁英", lootid = "AQ20CAPTIAN" },
				dtl5  = { text = "德蘭上尉", colour = AM_RED, coords = { {57.2, 47.9} }, symbol = { "4" },
						tooltiptxt = "Lvl63 菁英", lootid = "AQ20CAPTIAN"  },
				dtl6  = { text = "瑟瑞姆上尉", colour = AM_RED, coords = { {59.2, 49.2} }, symbol = { "5" },
						tooltiptxt = "Lvl63 菁英", lootid = "AQ20CAPTIAN"  },
				dtl7  = { text = "葉吉斯少校", colour = AM_RED, coords = { {61.3, 50.3} }, symbol = { "6" },
						tooltiptxt = "Lvl63 菁英", lootid = "AQ20CAPTIAN"  },
				dtl8  = { text = "帕康少校", colour = AM_RED, coords = { {60, 53.4} }, symbol = { "7" },
						tooltiptxt = "Lvl63 菁英", lootid = "AQ20CAPTIAN"  },
				dtl9  = { text = "澤朗上校", colour = AM_RED, coords = { {56, 51.2} }, symbol = { "8" },
						tooltiptxt = "Lvl63 菁英", lootid = "AQ20CAPTIAN"  },
				dtl10 = { text = "拉賈克斯將軍", colour = AM_RED, coords = { {52.2, 49.5} }, symbol = { "9" },
						tooltiptxt = "首領", lootid = "AQ20Rajaxx"  },
				dtl11 = { text = "莫阿姆", colour = AM_RED, coords = { {13, 31} }, symbol = { "10" },
						tooltiptxt = "首領", lootid = "AQ20Moam"  },
				dtl12 = { text = "吞咽者布魯", colour = AM_RED, coords = { {83, 55} }, symbol = { "11" },
						tooltiptxt = "首領", lootid = "AQ20Buru"  },
				dtl13 = { text = "安全的房間", colour = AM_GREEN, coords = { {65, 70} }, symbol = { "12" },
						tooltiptxt = ""  },
				dtl14 = { text = "狩獵者阿亞米斯", colour = AM_RED, coords = { {67, 91} }, symbol = { "13" },
						tooltiptxt = "首領", lootid = "AQ20Ayamiss"  },
				dtl15 = { text = "無疤者奧斯里安", colour = AM_RED, coords = { {29, 73} }, symbol = { "14" },
						tooltiptxt = "首領", lootid = "AQ20Ossirian", leaveGap = 2  },
				dtl16 = { text = "職業書籍", colour = AM_BLUE, coords = { {0, 0} }, symbol = { " " },
			...
			{ 	name = "奧特蘭克山谷",			-- Alterac Valley
				...
				dtl8  = { text = "石爐墓地", colour = AM_GREEN, coords = { {83.68, 32.53}, {57, 32.53} }, symbol = { "3" },
						tooltiptxt = "", bgPOI = true },
				dtl9  = { text = "落雪墓地", colour = AM_GREEN, coords = { {70.89, 44.37}, {57, 44.37} }, symbol = { "4" },
						tooltiptxt = "", bgPOI = true },
				dtl10 = { text = "冰血墓地", colour = AM_GREEN, coords = { {83.49, 60.99}, {57, 60.99} }, symbol = { "5" },
						tooltiptxt = "", bgPOI = true },
				dtl11 = { text = "霜狼墓地", colour = AM_GREEN, coords = { {80.66, 80.18}, {57, 80.18} }, symbol = { "6" },
						tooltiptxt = "", bgPOI = true },
				...
				dtl20 = { text = "丹巴達爾南部碉堡", colour = AM_BLUE, coords = { {70.50, 13.53}, {60, 13.53} }, symbol = { "10" },
						tooltiptxt = "", bgPOI = true },
				...
				dtl25 = { text = "東部霜狼哨塔", colour = AM_RED, coords = { {80.4, 89.04}, {63, 89.05} }, symbol = { "14" },
						tooltiptxt = "", bgPOI = true },
				dtl26 = { text = "西部霜狼哨塔", colour = AM_RED, coords = { {77, 88.5}, {60, 88.5} }, symbol = { "15" },
						tooltiptxt = "", bgPOI = true, leaveGap = 1 },
