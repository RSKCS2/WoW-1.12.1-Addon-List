...
function SetWrangler_MakeWarlockData()
	...
	setStats= SW_TEXT_BONUS_HEADER.."\n\n"
			  ..SW_GOLD_OPEN.."3:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." +4 Fire Resistance, +4 Shadow Resistance.\n\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."5:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." Increases damage done to Demons by magical spells and effects by up to 14.\n\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."6:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." Increases damage done by Shadow spells and effects by up to 21.\n\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."7:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." Restores 5 health every 5 sec.\n\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."8:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." Improves your chance to get a critical strike with Shadow spells by 2%.\n\n"..SW_LINK_COLOR_CLOSE
	...
	for i=6,7 do
		if (i == 6) then
			setName = "Lieutenant Commander's Threads";
			setTabName = "Lt Commander";
			
			handsLink		= "item:17564:0:0:0";
			feetLink		= "item:17562:0:0:0";
			chestLink		= "item:17568:0:0:0";
			legsLink		= "item:17567:0:0:0";
			shoulderLink	= "item:17569:0:0:0";
			headLink		= "item:17566:0:0:0";
			
			setInfo = "PvP Tier 1 Set - (Alliance)";
			
			SW_TEXT_RANK_NAMES = SW_TEXT_RANK_NAMES_A;
		else
			setName = "Champion's Threads";
			setTabName = "Champion";

			handsLink		= "item:17577:0:0:0";
			feetLink		= "item:17576:0:0:0";
			chestLink		= "item:17572:0:0:0";
			legsLink		= "item:17571:0:0:0";
			shoulderLink	= "item:17573:0:0:0";
			headLink		= "item:17570:0:0:0";
		...
		setStats= SW_TEXT_BONUS_HEADER.."\n\n"
				  ...
				  ..SW_GOLD_OPEN.."Intellect: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."101\n"..SW_LINK_COLOR_CLOSE
