...
function SetWrangler_MakeShamanData()
	...
	setStats= SW_TEXT_BONUS_HEADER.."\n\n"
			  ...
			  ..SW_GOLD_OPEN.."5:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." +5 Frost Resistance, +5 Fire Resistance, +5 Nature Resistance.\n\n"..SW_LINK_COLOR_CLOSE
			  ...
			  ..SW_GOLD_OPEN.."8:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." Improves your chance to get a critical strike with Nature spells by 2%.\n\n"..SW_LINK_COLOR_CLOSE
	...
	setName = "Champion's Earthshaker";
	setTabName = "Champion";

	handsLink		= "item:16519:0:0:0";
	feetLink		= "item:16518:0:0:0";
	chestLink		= "item:16522:0:0:0";
	legsLink		= "item:16523:0:0:0";
	shoulderLink	= "item:16524:0:0:0";
	headLink		= "item:16521:0:0:0";
	...
	setStats= SW_TEXT_BONUS_HEADER.."\n\n"
			  ...
			  ..SW_GOLD_OPEN.."Strength: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."19\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."Agility: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."10\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."Stamina: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."110\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."Intellect: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."72\n"..SW_LINK_COLOR_CLOSE
	...
	setStats= SW_TEXT_BONUS_HEADER.."\n\n"
			  ...
			  ..SW_GOLD_OPEN.."Agility: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."23\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."Stamina: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."146\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."Intellect: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."99\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."%Critical: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."2\n"..SW_LINK_COLOR_CLOSE
