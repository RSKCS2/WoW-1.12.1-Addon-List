...
AM_ALPHAMAP_LIST = {
		{	name = "Blackfathom Deeps",			-- Blackfathom Deeps
			...
			dtl9  = { text = "Baron Aquanis,\n& Fathom Core", colour = AM_RED, coords = { {52, 76} }, symbol = { "7" },
					tooltiptxt = "Lvl28 Elite Humanoid", lootid = "BFDBaronAquanis" },
			dtl10  = { text = "Twilight Lord Kelris,\n& Blackfathom Deeps Altar", colour = AM_RED, coords = { {63, 81} }, symbol = { "8" },
					tooltiptxt = "Lvl27 Elite Humanoid", lootid = "BFDTwilightLordKelris" },
			dtl11  = { text = "Old Serra'kis", colour = AM_RED, coords = { {63, 74} }, symbol = { "9" },
					tooltiptxt = "Lvl26 Elite Beast", lootid = "BFDOldSerrakis" },
			dtl12 = { text = "Aku'mai", colour = AM_RED, coords = { {95, 85} }, symbol = { "10" },
		...
		{	name = "Blackrock Depths",			-- Blackrock Depths
			...
			dtl14 = { text = "Lord Incendius", colour = AM_RED, coords = { {48.7, 48.1} }, symbol = { "12" },
					tooltiptxt = "'Incendius!' Quest", lootid = "BRDLordIncendius" },
			dtl15 = { text = "The Black Anvil", colour = AM_RED, coords = { {48.7, 48.1} }, symbol = { " " },
					tooltiptxt = "" },
			dtl16 = { text = "ShadowForge Lock", colour = AM_GREEN, coords = { {31, 72.4} }, symbol = { "13" },
					tooltiptxt = "Unlock to allow deeper access to higher level areas\nRequires Shadowforge Key" },
			dtl17 = { text = "Bael'Gar", colour = AM_RED, coords = { {8, 62} }, symbol = { "14" },
					tooltiptxt = "Lvl57 Elite Mountain Giant", lootid = "BRDBaelGar" },
			dtl18 = { text = "General Angerforge", colour = AM_RED, coords = { {24, 64} }, symbol = { "15" },
					tooltiptxt = "Lvl57 Elite Dwarf", lootid = "BRDGeneralAngerforge" },
			dtl19 = { text = "Golem Lord Argelmach", colour = AM_RED, coords = { {24, 51} }, symbol = { "16" },
					tooltiptxt = "Lvl58 Elite Dwarf", lootid = "BRDGolemLordArgelmach" },
			dtl20 = { text = "The Grim Guzzler", colour = AM_GREEN, coords = { {40, 50} }, symbol = { "17" },
					tooltiptxt = "Buy 6 Dark Iron Ale mugs\nand give them to Rocknot ;P", lootid = "BRDGuzzler" },
			dtl21 = { text = "Ambassador Flamelash", colour = AM_RED, coords = { {46, 38} }, symbol = { "18" },
					tooltiptxt = "Lvl57 Elite Humanoid", lootid = "BRDFlamelash" },
			dtl22 = { text = "Panzor the Invincible", colour = AM_RED, coords = { {40, 27} }, symbol = { "19" },
					tooltiptxt = "Lvl57 Elite Golem", special = AM_RARE, lootid = "BRDPanzor" },
			dtl23 = { text = "Summoner's Tomb", colour = AM_GREEN, coords = { {46, 18} }, symbol = { "20" },
					tooltiptxt = "Defeat 7 bosses in sequence to go deeper\n& Chest", lootid = "BRDTomb" },
			dtl24 = { text = "The Lyceum", colour = AM_GREEN, coords = { {61, 8.5} }, symbol = { "21" },
					tooltiptxt = "Find and defeat 2 Flamekeepers\nand light both torches to progress.\nOnly have 3 minutes from killing the first." },
			dtl25 = { text = "Magmus", colour = AM_RED, coords = { {78, 8.5} }, symbol = { "22" },
					tooltiptxt = "Lvl57 Elite Mountain Giant", lootid = "BRDMagmus" },
			dtl26 = { text = "Princess Moira Bronzebeard", colour = AM_RED, coords = { {90, 8} }, symbol = { "23" },
					tooltiptxt = "Lvl58 Elite Humanoid", lootid = "BRDPrincess" },
			dtl27 = { text = "Emperor Dagran Thaurissan", colour = AM_RED, coords = { {93, 8.5} }, symbol = { "24" },
					tooltiptxt = "Lvl59 Elite Humanoid", lootid = "BRDImperatorDagranThaurissan" },
			dtl28 = { text = "The Black Forge", colour = AM_GREEN, coords = { {63, 22} }, symbol = { "23" },
					tooltiptxt = "Forge Dark Iron,\nand make Smoking Heart of the Mountain" },
			dtl29 = { text = "Molten Core", colour = AM_ORANGE, coords = { {65, 30} }, symbol = { "24" },
		...
		{	name = "Dire Maul"..AM_EXTERIOR,		-- Dire Maul Exterior
			type = AM_TYP_RAID,
			displayname = "Dire Maul - Exterior",
			displayshort = "DM",
		...
		{	name = "Dire Maul West",		-- Dire Maul West
			...
			dtl11 = { text = "Prince Tortheldrin", colour = AM_RED, coords = { {41, 26} }, symbol = { "7" },
					tooltiptxt = "Lvl61 Elite Humanoid", lootid = "DMWPrinceTortheldrin", leaveGap = 1  },
			dtl12 = { text = "Library", colour = AM_BLUE, coords = { {51, 20} }, symbol = { "8" },
					tooltiptxt = "", leaveGap = 1 },
			dtl13 = { text = "Books", colour = AM_BLUE, coords = { {0, 0} }, symbol = { " " },
					tooltiptxt = "", lootid = "DMBooks", leaveGap = 1 }
		},
		...
		{	name = "Four Dragons: Hinterlands",			-- Four Dragons
			...
			location = "Duskwood : Seradane (46, 36)",
			minimapZoom = 2,
			minimapXOffset = 0,
			minimapYOffset = 0,
			area = "Hinterlands",
		...
		{	name = "Maraudon",			-- Maraudon
			...
			prereq = "",
			general = "",
			dtl1  = { text = "Entrance (Orange)", colour = AM_GREEN, coords = { {71, 12} }, symbol = { "X1" },
					tooltiptxt = "" },
			dtl2  = { text = "Entrance (Purple)", colour = AM_GREEN, coords = { {85, 31} }, symbol = { "X2" },
					tooltiptxt = "" },
		...
		{	name = "Ruins of Ahn'Qiraj",		-- Ruins of Ahn'Qiraj
			...
			dtl12 = { text = "Buru the Gorger", colour = AM_RED, coords = { {83, 55} }, symbol = { "11" },
					tooltiptxt = "Boss", lootid = "AQ20Buru"  },
			dtl13 = { text = "Safe Room", colour = AM_GREEN, coords = { {65, 70} }, symbol = { "12" },
					tooltiptxt = ""  },
			dtl14 = { text = "Ayamiss the Hunter", colour = AM_RED, coords = { {67, 91} }, symbol = { "13" },
					tooltiptxt = "Boss", lootid = "AQ20Ayamiss"  },
			dtl15 = { text = "Ossirian the Unscarred", colour = AM_RED, coords = { {29, 73} }, symbol = { "14" },
					tooltiptxt = "Boss", lootid = "AQ20Ossirian", leaveGap = 2  },
			dtl16 = { text = "Class Books", colour = AM_BLUE, coords = { {0, 0} }, symbol = { " " },
					tooltiptxt = "", lootid = "AQ20ClassBooks" },
			dtl17 = { text = AM_ENCHANTS, colour = AM_BLUE, coords = { {0, 0} }, symbol = { " " },
					tooltiptxt = "", lootid = "AQEnchants" },
			dtl18 = { text = "AQ20"..AM_CLASS_SETS.." 1", colour = AM_ORANGE, coords = { {0, 0} }, symbol = { " " },
					tooltiptxt = "Mage, Rogue, Warlock, Druid, Priest", lootid = "AQ20QuestReward" },
			dtl19 = { text = "AQ20"..AM_CLASS_SETS.." 2", colour = AM_ORANGE, coords = { {0, 0} }, symbol = { " " },
					tooltiptxt = "Hunter, Shaman, Paladin, Warrior", lootid = "AQ20QuestReward2" }
		},
		...
		{	name = "Ahn'Qiraj",			-- Ahn'Qiraj
			...
			dtl15 = { text = "AQ40 "..AM_CLASS_SETS.." 1", colour = AM_ORANGE, coords = { {0, 0} }, symbol = { " " },
					tooltiptxt = "Paladin, Shaman, Mage, Warrior", lootid = "AQ40Set1" },
			dtl16 = { text = "AQ40 "..AM_CLASS_SETS.." 2", colour = AM_ORANGE, coords = { {0, 0} }, symbol = { " " },
					tooltiptxt = "Priest, Rogue, Warlock, Hunter", lootid = "AQ40Set2" },
			dtl17 = { text = "AQ40 "..AM_CLASS_SETS.." 3", colour = AM_ORANGE, coords = { {0, 0} }, symbol = { " " },
					tooltiptxt = "Druid", lootid = "AQ40Set3", leaveGap = 1 },
		...
		{	name = "Zul'Gurub",			-- Zul'Gurub
			...
			dtl18 = { text = "ZG"..AM_CLASS_SETS.." 1", colour = AM_ORANGE, coords = { {0, 0} }, symbol = { " " },
					tooltiptxt = "Mage, Priest, Warlock, Rogue", lootid = "ZGQuestItems" },
			dtl19 = { text = "ZG"..AM_CLASS_SETS.." 2", colour = AM_ORANGE, coords = { {0, 0} }, symbol = { " " },
					tooltiptxt = "Druid, Shaman, Hunter, Warrior", lootid = "ZGQuestItems2" },
			dtl20 = { text = "ZG"..AM_CLASS_SETS.." 3", colour = AM_ORANGE, coords = { {0, 0} }, symbol = { " " },
					tooltiptxt = "Paladin", lootid = "ZGQuestItems3" },
			dtl21 = { text = AM_RBOSS_DROP, colour = AM_PURPLE, coords = { {0, 0} }, symbol = { " " },
					tooltiptxt = "", lootid = "ZGShared", leaveGap = 1 },
			dtl22 = { text = AM_ENCHANTS, colour = AM_BLUE, coords = { {0, 0} }, symbol = { " " },
		...
		{	name = "Scholomance",			-- Scholomance
			...
			dtl9  = { text = "Marduk Blackpool", colour = AM_BLUE, coords = { {23.7, 42} }, symbol = { "5" },
					tooltiptxt = "Lvl58 Elite\nAggro by placing Dawn's Gambit\nin Viewing room", lootid = "SCHOLOMarduk"  },
			dtl10 = { text = "Vectus", colour = AM_BLUE, coords = { {27.2, 42} }, symbol = { "6" },
					tooltiptxt = "Lvl60 Elite Undead\nAggro by placing Dawn's Gambit\nin Viewing room", lootid = "SCHOLOVectus"  },
			dtl11 = { text = "Ras Frostwhisper", colour = AM_RED, coords = { {18, 87} }, symbol = { "8" },
					tooltiptxt = "Lvl62 Elite Undead", lootid = "SCHOLORasFrostwhisper"  },
			dtl12 = { text = "Kormok", colour = AM_RED, coords = { {18, 80} }, symbol = { "9" },
					tooltiptxt = "Lvl60 Elite", lootid = "SCHOLOKormok" },
			dtl13 = { text = "Instructor Malicia", colour = AM_RED, coords = { {44.5, 94} }, symbol = { "10" },
					tooltiptxt = "Lvl60 Elite Humanoid", lootid = "SCHOLOInstructorMalicia"  },
			dtl14 = { text = "Doctor Theolen Krastinov", colour = AM_RED, coords = { {64, 74.2} }, symbol = { "11" },
					tooltiptxt = "Lvl60 Elite Humanoid", lootid = "SCHOLODoctorTheolenKrastinov"  },
			dtl15 = { text = "Lorekeeper Polkelt", colour = AM_RED, coords = { {44.8, 55.2} }, symbol = { "12" },
					tooltiptxt = "Lvl60 Elite Undead", lootid = "SCHOLOLorekeeperPolkelt"  },
			dtl16 = { text = "The Ravenian", colour = AM_RED, coords = { {75.8, 92} }, symbol = { "13" },
					tooltiptxt = "Lvl60 Elite Undead", lootid = "SCHOLOTheRavenian"  },
			dtl17 = { text = "Lord Alexei Barov", colour = AM_RED, coords = { {96.2, 74.5} }, symbol = { "14" },
					tooltiptxt = "Lvl60 Elite Undead", lootid = "SCHOLOLordAlexeiBarov"  },
			dtl18 = { text = "Lady Illucia Barov", colour = AM_RED, coords = { {75.6, 54} }, symbol = { "15" },
					tooltiptxt = "Lvl60 Elite Undead", lootid = "SCHOLOLadyIlluciaBarov" },
			dtl19 = { text = "Darkmaster Gandling", colour = AM_RED, coords = { {76.2, 74.4} }, symbol = { "16" },
					tooltiptxt = "Lvl61 Elite Humanoid", lootid = "SCHOLODarkmasterGandling", leaveGap = 1 },
			dtl20 = { text = "Torch Lever", colour = AM_GREEN, coords = { {89, 19} }, symbol = { "T" },
					tooltiptxt = "" },
			dtl21 = { text = "Alchemy Lab", colour = AM_GREEN, coords = { {14, 70} }, symbol = { "AL" },
					tooltiptxt = "", leaveGap = 1 },
			dtl22 = { text = "Deed to Southshore", colour = AM_ORANGE, coords = { {56, 25} }, symbol = { "D" },
					tooltiptxt = ""  },
			dtl23 = { text = "Deed to Tarren Mill", colour = AM_ORANGE, coords = { {11, 36} }, symbol = { "D" },
					tooltiptxt = ""  },
			dtl24 = { text = "Deed to Brill", colour = AM_ORANGE, coords = { {15, 77} }, symbol = { "D" },
					tooltiptxt = ""  },
			dtl25 = { text = "Deed to Caer Darrow", colour = AM_ORANGE, coords = { {94, 72} }, symbol = { "D" },
		...
		{ 	name = "Warsong Gulch",			-- Warsong Gulch
			...
			dtl9  = { text = "Friendly Rewards", colour = AM_GREEN, coords = { {0, 0 } }, symbol = { " " },
					tooltiptxt = "", lootid = "WSGFriendly" },
			dtl10 = { text = "Honoured Rewards", colour = AM_GREEN, coords = { {0, 0 } }, symbol = { " " },
					tooltiptxt = "", lootid = "WSGHonored" },
			dtl11 = { text = "Revered  Rewards", colour = AM_BLUE, coords = { {0, 0 } }, symbol = { " " },
					tooltiptxt = "", lootid = "WSGRevered" },
			dtl12 = { text = "Exalted  Rewards", colour = AM_PURPLE, coords = { {0, 0 } }, symbol = { " " },
		...
		{ 	name = "Arathi Basin",			-- Arathi Basin
			...
			dtl8  = { text = "Friendly Rewards", colour = AM_PURPLE, coords = { {0, 0 } }, symbol = { " " },
					tooltiptxt = "", lootid = "ABFriendly" },
			dtl9  = { text = "Honoured Rewards", colour = AM_PURPLE, coords = { {0, 0 } }, symbol = { " " },
					tooltiptxt = "", lootid = "ABHonored" },
			dtl10 = { text = "Revered  Rewards", colour = AM_PURPLE, coords = { {0, 0 } }, symbol = { " " },
					tooltiptxt = "", lootid = "ABRevered" },
			dtl11 = { text = "Exalted  Rewards", colour = AM_PURPLE, coords = { {0, 0 } }, symbol = { " " },
		...
		{ 	name = "Alterac Valley",			-- Alterac Valley
			...
			dtl8  = { text = "Stonehearth Graveyard", colour = AM_GREEN, coords = { {83.68, 32.53}, {57, 32.53} }, symbol = { "3" },
					tooltiptxt = "", bgPOI = true },
			dtl9  = { text = "Snowfall Graveyard", colour = AM_GREEN, coords = { {70.89, 44.37}, {57, 44.37} }, symbol = { "4" },
					tooltiptxt = "", bgPOI = true },
			dtl10 = { text = "Iceblood Graveyard", colour = AM_GREEN, coords = { {83.49, 60.99}, {57, 60.99} }, symbol = { "5" },
					tooltiptxt = "", bgPOI = true },
			dtl11 = { text = "Frostwolf Graveyard", colour = AM_GREEN, coords = { {80.66, 80.18}, {57, 80.18} }, symbol = { "6" },
					tooltiptxt = "", bgPOI = true },
			...
			dtl20 = { text = "Dun Baldar South Bunker", colour = AM_BLUE, coords = { {70.50, 13.53}, {60, 13.53} }, symbol = { "10" },
					tooltiptxt = "", bgPOI = true },
			...
			dtl25 = { text = "East Frostwolf Tower", colour = AM_RED, coords = { {80.4, 89.04}, {60, 89.04} }, symbol = { "14" },
					tooltiptxt = "", bgPOI = true },
			dtl26 = { text = "West Frostwolf Tower", colour = AM_RED, coords = { {77, 88.5}, {60, 88.5} }, symbol = { "15" },
					tooltiptxt = "", bgPOI = true, leaveGap = 1 },
...
-- Pad to dtl32 to control the page break
			...
			dtl53 = { text = "Friendly Rewards", colour = AM_PURPLE, coords = { {0, 0 } }, symbol = { " " },
					tooltiptxt = "", lootid = "AVFriendly" },
			dtl54 = { text = "Honoured Rewards", colour = AM_PURPLE, coords = { {0, 0 } }, symbol = { " " },
					tooltiptxt = "", lootid = "AVHonored" },
			dtl55 = { text = "Revered  Rewards", colour = AM_PURPLE, coords = { {0, 0 } }, symbol = { " " },
					tooltiptxt = "", lootid = "AVRevered" },
			dtl56 = { text = "Exalted  Rewards", colour = AM_PURPLE, coords = { {0, 0 } }, symbol = { " " },
