...
function SetWrangler_MakeMageData()
	...
	setStats= SW_TEXT_BONUS_HEADER.."\n\n"
			  ..SW_GOLD_OPEN.."3:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." Increases damage done by Frost spells and effects by up to 7.\n\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."5:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." +5 Frost Resistance, +5 Fire Resistance, +5 Arcane Resistance.\n\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."6:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." Increases damage done by Arcane spells and effects by up to 21.\n\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."7:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." Increases damage done by Fire spells and effects by up to 27.\n\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."8:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." Restores 8 mana per 5 sec, +10 Intellect.\n\n"..SW_LINK_COLOR_CLOSE
	...
	for i=6,7 do
		if (i == 6) then
			setName = "Lieutenant Commander's Regalia";
			setTabName = "Lt Commander";
			
			handsLink		= "item:16391:0:0:0";
			feetLink		= "item:16369:0:0:0";
			chestLink		= "item:16413:0:0:0";
			legsLink		= "item:16414:0:0:0";
			shoulderLink	= "item:16415:0:0:0";
			headLink		= "item:16416:0:0:0";
			
			setInfo = "PvP Tier 1 Set - (Alliance)";
			
			SW_TEXT_RANK_NAMES = SW_TEXT_RANK_NAMES_A;
		else
			setName = "Champion's Regalia";
			setTabName = "Champion";

			handsLink		= "item:16487:0:0:0";
			feetLink		= "item:16485:0:0:0";
			chestLink		= "item:16491:0:0:0";
			legsLink		= "item:16490:0:0:0";
			shoulderLink	= "item:16492:0:0:0";
			headLink		= "item:16489:0:0:0";
		...
		setStats= SW_TEXT_BONUS_HEADER.."\n\n"
				  ...
				  ..SW_GOLD_OPEN.."Armor: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."424\n"..SW_LINK_COLOR_CLOSE
				  ..SW_GOLD_OPEN.."Stamina: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."95\n"..SW_LINK_COLOR_CLOSE
				  ..SW_GOLD_OPEN.."Intellect: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."79\n"..SW_LINK_COLOR_CLOSE
	...
	for i=8,9 do
		...
		setStats= SW_TEXT_BONUS_HEADER.."\n\n"
				  ...
				  ..SW_GOLD_OPEN.."Armor: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."476\n"..SW_LINK_COLOR_CLOSE
