...
function SetWrangler_MakeDruidData()
	...
	setStats= SW_TEXT_BONUS_HEADER.."\n\n"
			  ..SW_GOLD_OPEN.."3:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." +5 Nature Resistance.\n\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."5:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." Increases damage done by Nature spells and effects by up to 14.\n\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."6:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." Increases damage done by Arcane spells and effects by up to 21.\n\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."7:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." Increases healing done by spells and effects by up to 44.\n\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."8:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." +17 Stamina, +17 Strength.\n\n"..SW_LINK_COLOR_CLOSE
	...
	for i=6,7 do
		if (i == 6) then
			setName = "Lieutenant Commander's Sanctuary";
			setTabName = "Lt Commander";
			
			handsLink		= "item:16397:0:0:0";
			feetLink		= "item:16393:0:0:0";
			chestLink		= "item:16421:0:0:0";
			legsLink		= "item:16422:0:0:0";
			shoulderLink	= "item:16423:0:0:0";
			headLink		= "item:16424:0:0:0";
			
			setInfo = "PvP Tier 1 Set - (Alliance)";
			
			SW_TEXT_RANK_NAMES = SW_TEXT_RANK_NAMES_A;
		else
			setName = "Champion's Sanctuary";
			setTabName = "Champion";

			handsLink		= "item:16496:0:0:0";
			feetLink		= "item:16494:0:0:0";
			chestLink		= "item:16504:0:0:0";
			legsLink		= "item:16502:0:0:0";
			shoulderLink	= "item:16501:0:0:0";
			headLink		= "item:16503:0:0:0";
		...
		setStats= SW_TEXT_BONUS_HEADER.."\n\n"
				  ...
				  ..SW_GOLD_OPEN.."Strength: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."70\n"..SW_LINK_COLOR_CLOSE
				  ..SW_GOLD_OPEN.."Agility: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."59\n"..SW_LINK_COLOR_CLOSE
				  ..SW_GOLD_OPEN.."Stamina: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."76\n"..SW_LINK_COLOR_CLOSE
				  ..SW_GOLD_OPEN.."Intellect: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."39\n"..SW_LINK_COLOR_CLOSE
	...
	for i=8,9 do
		...
		setStats= SW_TEXT_BONUS_HEADER.."\n\n"
				  ...
				  ..SW_GOLD_OPEN.."Strength: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."95\n"..SW_LINK_COLOR_CLOSE
				  ..SW_GOLD_OPEN.."Agility: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."85\n"..SW_LINK_COLOR_CLOSE
				  ..SW_GOLD_OPEN.."Stamina: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."90\n"..SW_LINK_COLOR_CLOSE
				  ..SW_GOLD_OPEN.."Intellect: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."63\n"..SW_LINK_COLOR_CLOSE
	...
	setStats= SW_TEXT_BONUS_HEADER.."\n\n"
			  ...
			  ..SW_GOLD_OPEN.."3:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." Increased Defense +15.\n\n"..SW_LINK_COLOR_CLOSE
