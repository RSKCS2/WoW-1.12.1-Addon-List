...
function SetWrangler_MakePriestData()
	...
	setStats= SW_TEXT_BONUS_HEADER.."\n\n"
			  ..SW_GOLD_OPEN.."3:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." Increases damage done by Shadow spells and effects by up to 7.\n\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."5:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." Increases damage done to Undead by magical spells and effects by up to 14.\n\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."6:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." +15 Shadow Resistance.\n\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."7:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." +20 Spirit.\n\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."8:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." Increases healing done by spells and effects by up to 55.\n\n"..SW_LINK_COLOR_CLOSE
	...
	for i=6,7 do
		if (i == 6) then
			setName = "Lieutenant Commander's Raiment";
			setTabName = "Lt Commander";
			
			handsLink		= "item:17596:0:0:0";
			feetLink		= "item:17594:0:0:0";
			chestLink		= "item:17600:0:0:0";
			legsLink		= "item:17599:0:0:0";
			shoulderLink	= "item:17601:0:0:0";
			headLink		= "item:17598:0:0:0";
			
			setInfo = "PvP Tier 1 Set - (Alliance)";
			
			SW_TEXT_RANK_NAMES = SW_TEXT_RANK_NAMES_A;
		else
			setName = "Champion's Raiment";
			setTabName = "Champion";

			handsLink		= "item:17617:0:0:0";
			feetLink		= "item:17616:0:0:0";
			chestLink		= "item:17612:0:0:0";
			legsLink		= "item:17611:0:0:0";
			shoulderLink	= "item:17613:0:0:0";
			headLink		= "item:17610:0:0:0";
		...
		setStats= SW_TEXT_BONUS_HEADER.."\n\n"
				  ...
				  ..SW_GOLD_OPEN.."Stamina: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."99\n"..SW_LINK_COLOR_CLOSE
	...
	for i=8,9 do
		...
		setStats= SW_TEXT_BONUS_HEADER.."\n\n"
				  ...
				  ..SW_GOLD_OPEN.."Spirit: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."19\n"..SW_LINK_COLOR_CLOSE
