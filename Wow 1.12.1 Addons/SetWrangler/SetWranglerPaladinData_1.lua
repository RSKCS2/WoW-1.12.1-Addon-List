...
function SetWrangler_MakePaladinData()
	...
	setStats= SW_TEXT_BONUS_HEADER.."\n\n"
			  ..SW_GOLD_OPEN.."3:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." Increases healing done by spells and effects by up to 11.\n\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."5:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." +30 Attack Power when fighting Undead, +30 Attack Power when fighting Demons.\n\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."6:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." +6 All Resistances\n\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."7:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." +10% chance to resist Fear spells and effects.\n\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."8:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." When the victim of a critical hit in combat, 1% chance to be sheathed in a magical shield absorbing the next 500 damage.\n\n"..SW_LINK_COLOR_CLOSE
	...
	setName = "Lieutenant Commander's Aegis";
	setTabName = "Lt Commander";
		
	handsLink		= "item:16410:0:0:0";
	feetLink		= "item:16409:0:0:0";
	chestLink		= "item:16433:0:0:0";
	legsLink		= "item:16435:0:0:0";
	shoulderLink	= "item:16436:0:0:0";
	headLink		= "item:16434:0:0:0";
		
	setIndex = 6;
	setInfo = "PvP Tier 1 Set";
	setStats= SW_TEXT_BONUS_HEADER.."\n\n"
			  ..SW_GOLD_OPEN.."2:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." +6 Intellect, Improves your chance to get a critical strike by 1%.\n\n"..SW_LINK_COLOR_CLOSE
			  ...
			  ..SW_GOLD_OPEN.."Intellect: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."14\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."Spirit: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."5\n"..SW_LINK_COLOR_CLOSE
	...
	setStats= SW_TEXT_BONUS_HEADER.."\n\n"
			  ...
			  ..SW_GOLD_OPEN.."6:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." +6 Intellect, Improves your chance to get a critical strike by 1%.\n\n"..SW_LINK_COLOR_CLOSE
			  ...
			  ..SW_GOLD_OPEN.."Stamina: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."149\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."Intellect: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."18\n"..SW_LINK_COLOR_CLOSE
