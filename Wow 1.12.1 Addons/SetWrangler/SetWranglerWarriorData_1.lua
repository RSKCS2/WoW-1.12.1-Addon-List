...
function SetWrangler_MakeWarriorData()
	...
	setStats= SW_TEXT_BONUS_HEADER.."\n\n"
			  ...
			  ..SW_GOLD_OPEN.."5:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." +20 Attack Power.\n\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."6:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." When struck in combat inflicts 2 Arcane damage to the attacker.\n\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."7:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." Restores 5 health every 5 sec.\n\n"..SW_LINK_COLOR_CLOSE
			  ..SW_GOLD_OPEN.."8:"..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.." 1% chance to stun a victim struck in combat for 1 sec.\n\n"..SW_LINK_COLOR_CLOSE
	...
	for i=6,7 do
		if (i == 6) then
			setName = "Lieutenant Commander's Battlegear";
			setTabName = "Lt Commander";
			
			handsLink		= "item:16406:0:0:0";
			feetLink		= "item:16405:0:0:0";
			chestLink		= "item:16430:0:0:0";
			legsLink		= "item:16431:0:0:0";
			shoulderLink	= "item:16432:0:0:0";
			headLink		= "item:16429:0:0:0";
			
			setInfo = "PvP Tier 1 Set - (Alliance)";
			
			SW_TEXT_RANK_NAMES = SW_TEXT_RANK_NAMES_A;
		else
			setName = "Champion's Battlegear";
			setTabName = "Champion";

			handsLink		= "item:16510:0:0:0";
			feetLink		= "item:16509:0:0:0";
			chestLink		= "item:16513:0:0:0";
			legsLink		= "item:16515:0:0:0";
			shoulderLink	= "item:16516:0:0:0";
			headLink		= "item:16514:0:0:0";
		...
		setStats= SW_TEXT_BONUS_HEADER.."\n\n"
				  ...
				  ..SW_GOLD_OPEN.."Armor: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."3121\n"..SW_LINK_COLOR_CLOSE
				  ..SW_GOLD_OPEN.."Strength: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."56\n"..SW_LINK_COLOR_CLOSE
				  ..SW_GOLD_OPEN.."Agility: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."25\n"..SW_LINK_COLOR_CLOSE
				  ..SW_GOLD_OPEN.."Stamina: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."130\n"..SW_LINK_COLOR_CLOSE
				  ..SW_GOLD_OPEN.."%Critical: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."3\n"..SW_LINK_COLOR_CLOSE
				  ..SW_GOLD_OPEN.."Durability: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."505\n"..SW_LINK_COLOR_CLOSE;
		classData.aSetData[setIndex]							= SetWrangler_MakeSetData(setName,setTabName,setInfo,setStats);
	...
	for i=8,9 do
		...
		setStats= SW_TEXT_BONUS_HEADER.."\n\n"
				  ...
				  ..SW_GOLD_OPEN.."Armor: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."3504\n"..SW_LINK_COLOR_CLOSE
				  ..SW_GOLD_OPEN.."Strength: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."96\n"..SW_LINK_COLOR_CLOSE
				  ..SW_GOLD_OPEN.."Agility: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."65\n"..SW_LINK_COLOR_CLOSE
				  ..SW_GOLD_OPEN.."Stamina: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."159\n"..SW_LINK_COLOR_CLOSE
				  ..SW_GOLD_OPEN.."%Critical: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."3\n"..SW_LINK_COLOR_CLOSE
				  ..SW_GOLD_OPEN.."Durability: "..SW_LINK_COLOR_CLOSE..SW_WHITE_OPEN.."615\n"..SW_LINK_COLOR_CLOSE;
		classData.aSetData[setIndex]							= SetWrangler_MakeSetData(setName,setTabName,setInfo,setStats);
