...
-- Francais
	...
	AM_ALPHAMAP_LIST = {
			...
			{	name = "Hache-Tripes"..AM_EXTERIOR,		-- Hache-Tripes Ext\195\169rieur
				type = AM_TYP_RAID,
				displayname = "Hache-Tripes - Ext\195\169rieur",
				displayshort = "DM",
			...
			{	name = "Gnomeregan"..AM_EXTERIOR,			-- Gnomeregan
				type = AM_TYP_RAID,
				displayname = "Gnomeregan Instance Ext\195\169rieur",
			...
			{	name = "Maraudon"..AM_EXTERIOR,		-- Maraudon Ext\195\169rieur
				type = AM_TYP_RAID,
				displayname = "Maraudon - Ext\195\169rieur",
				displayshort = "",
			...
			{	name = "Ruines d'Ahn'Qiraj",		-- Ruines d'Ahn'Qiraj
				...
				dtl1  = { text = AM_INSTANCE_ENTRANCES, colour = AM_GREEN, coords = { {64, 2} }, symbol = { AM_ENTRANCE_SYMBOL },
						tooltiptxt = "", leaveGap = 1 },
				dtl2  = { text = "Kurinnaxx,\n& G\195\169n\195\169ral de division Andorov,\n&Quatre \195\169lites kaldorei", colour = AM_RED, coords = { {55, 29} }, symbol = { "1" },
						tooltiptxt = "Boss & Elites", lootid = "AQ20Kurinnaxx" },
				dtl3  = { text = "Capitaine Qeez", colour = AM_RED, coords = { {52.1, 46.9} }, symbol = { "2" },
						tooltiptxt = "Lvl63 Elite", lootid = "AQ20CAPTIAN" },
				dtl4  = { text = "Capitaine Tuubid", colour = AM_RED, coords = { {55.4, 46.9} }, symbol = { "3" },
						tooltiptxt = "Lvl63 Elite", lootid = "AQ20CAPTIAN" },
				dtl5  = { text = "Capitaine Drenn", colour = AM_RED, coords = { {57.2, 47.9} }, symbol = { "4" },
						tooltiptxt = "Lvl63 Elite", lootid = "AQ20CAPTIAN"  },
				dtl6  = { text = "Capitaine Xurrem", colour = AM_RED, coords = { {59.2, 49.2} }, symbol = { "5" },
						tooltiptxt = "Lvl63 Elite", lootid = "AQ20CAPTIAN"  },
				...
				dtl9  = { text = "Colonel Zerran", colour = AM_RED, coords = { {56, 51.2} }, symbol = { "8" },
						tooltiptxt = "Lvl63 Elite", lootid = "AQ20CAPTIAN"  },
				dtl10 = { text = "G\195\169n\195\169ral Rajaxx", colour = AM_RED, coords = { {52.2, 49.5} }, symbol = { "9" },
						tooltiptxt = "Boss", lootid = "AQ20Rajaxx"  },
				dtl11 = { text = "Moam", colour = AM_RED, coords = { {13, 31} }, symbol = { "10" },
						tooltiptxt = "Boss", lootid = "AQ20Moam"  },
				dtl12 = { text = "Buru Grandgosier", colour = AM_RED, coords = { {83, 55} }, symbol = { "11" },
						tooltiptxt = "Boss", lootid = "AQ20Buru"  },
				dtl13 = { text = "Pi\195\168ce s\195\187re", colour = AM_GREEN, coords = { {65, 70} }, symbol = { "12" },
						tooltiptxt = ""  },
				dtl14 = { text = "Ayamiss le chasseur", colour = AM_RED, coords = { {67, 91} }, symbol = { "13" },
						tooltiptxt = "Boss", lootid = "AQ20Ayamiss"  },
				dtl15 = { text = "Ossirian l'Intouch\195\169", colour = AM_RED, coords = { {29, 73} }, symbol = { "14" },
						tooltiptxt = "Boss", lootid = "AQ20Ossirian", leaveGap = 2  },
				dtl16 = { text = "Livres de Classe", colour = AM_BLUE, coords = { {0, 0} }, symbol = { " " },
			...
			{	name = "Ahn'Qiraj",			-- Ahn'Qiraj
				...
				dtl17 = { text = "AQ40 "..AM_CLASS_SETS, colour = AM_ORANGE, coords = { {0, 0} }, symbol = { " " },
			...
			{ 	name = "Bassin d'Arathi",			-- Bassin d'Arathi
				...
				dtl4  = { text = "Mine", colour = AM_GREEN, coords = { {72.81, 30.54}, {9, 34.0} }, symbol = { "M" },
						tooltiptxt = "Capture", bgPOI = true },
			...
			{ 	name = "Vall\195\169e d'Alterac",			-- Vall\195\169e d'Alterac
				...
				dtl8  = { text = "Cimeti\195\168re Stonehearth", colour = AM_GREEN, coords = { {83.68, 32.53}, {57, 32.53} }, symbol = { "3" },
						tooltiptxt = "", bgPOI = true },
				dtl9  = { text = "Cimeti\195\168re des Neiges", colour = AM_GREEN, coords = { {70.89, 44.37}, {57, 44.37} }, symbol = { "4" },
						tooltiptxt = "", bgPOI = true },
				dtl10 = { text = "Cimeti\195\168re  de Glacesang", colour = AM_GREEN, coords = { {83.49, 60.99}, {57, 60.99} }, symbol = { "5" },
						tooltiptxt = "", bgPOI = true },
				dtl11 = { text = "Cimeti\195\168re Frostwolf", colour = AM_GREEN, coords = { {80.66, 80.18}, {57, 80.18} }, symbol = { "6" },
						tooltiptxt = "", bgPOI = true },
				...
				dtl20 = { text = "Fortin sud de Dun Baldar", colour = AM_BLUE, coords = { {70.50, 13.53}, {60, 13.53} }, symbol = { "10" },
						tooltiptxt = "", bgPOI = true },
				...
				dtl25 = { text = "Tour De Frostwolf Est", colour = AM_RED, coords = { {80.4, 89.04}, {63, 89.05} }, symbol = { "14" },
						tooltiptxt = "", bgPOI = true },
				dtl26 = { text = "Tour De Frostwolf Ouest", colour = AM_RED, coords = { {77, 88.5}, {60, 88.5} }, symbol = { "15" },
						tooltiptxt = "", bgPOI = true, leaveGap = 1 },
